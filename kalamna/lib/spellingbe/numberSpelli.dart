...
class NumberSpelli extends StatefulWidget {
  const NumberSpelli({Key? key}) : super(key: key);

  @override
  State<NumberSpelli> createState() => _NumberSpelliState();
}

class _NumberSpelliState extends State<NumberSpelli> {
  final List<String> _words = numberWords.toList();
  late String _word;
